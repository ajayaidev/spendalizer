...
1. **On Emergent Preview** (`https://budget-wise-11.preview.emergentagent.com`):
   - Email reset links will use: `https://budget-wise-11.preview.emergentagent.com/reset-password?token=...`
...
1. Navigate to: https://budget-wise-11.preview.emergentagent.com/forgot-password
