...
**URL:** https://budget-buddy-3836.preview.emergentagent.com

1. Update `backend/.env` with your SMTP credentials (see above)
2. Wait ~10 seconds for backend to auto-reload
3. Test:
   - Go to: https://budget-buddy-3836.preview.emergentagent.com/forgot-password
   - Enter a registered email
   - Check your inbox
   - Reset link will use: `https://budget-buddy-3836.preview.emergentagent.com/reset-password?token=...`
...
- **Request from Emergent** → Uses `https://budget-buddy-3836.preview.emergentagent.com`
...
```bash
# On Emergent
curl -X POST "https://budget-buddy-3836.preview.emergentagent.com/api/auth/forgot-password" \
